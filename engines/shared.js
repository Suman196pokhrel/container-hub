...
// (the full, untruncated form). Anything that reaches a shell string (the
// log-fetch pipeline, in either engine) is gated through this first, so a
// value that doesn't match this exact shape is never substituted in.
